                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                                ...
                                %>
                                <a href="view_products.jsp?product_id=<%= products.getId() %>" class="btn btn-sm btn-secondary">Details</a>
                                <%
                                } else if (role.equals("admin")) {
                                %>
                                <a href="view_products.jsp?product_id=<%= products.getId() %>" class="btn btn-sm btn-secondary">Details</a>
                                <a href="edit_products.jsp?product_id=<%= products.getId() %>" class="btn btn-sm btn-warning">Modify</a>
